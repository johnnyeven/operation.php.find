...
<head lang="en">
    ...
    <link rel="stylesheet" href="/assets/css/project-module.css">
            ...
            <div class="row">
                <div class="col-md-2">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li role="presentation" class="active"><a href="{%baseUrl($params['userName'])%}/{%$params['projectName']%}/module"><span class="glyphicon glyphicon-th-large"></span> 模块 <span class="badge">2</span></a></li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="glyphicon glyphicon-th-large"></span> 模块</h3>
                                </div>
...
<script type="text/javascript" src="/assets/js/project-module.js"></script>