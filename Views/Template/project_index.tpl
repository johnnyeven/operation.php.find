            ...
            <div class="row">
                <div class="col-md-2">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li role="presentation"><a href="#">需求</a></li>
                        <li role="presentation"><a href="#">模块</a></li>
                        <li role="presentation"><a href="#">任务</a></li>
                        <li role="presentation"><a href="#">问题</a></li>
                ...
                <div class="col-md-10">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> 成员 <span class="label label-success">12</span></h3>
                                </div>
                                <ul class="list-group">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="glyphicon glyphicon-signal"></span> 统计</h3>
                                </div>
