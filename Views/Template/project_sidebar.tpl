...
<ul class="nav nav-pills nav-stacked">
	...
	<li role="presentation"{%if in_array($params['pageName'], ['project_repo_tree'])%} class="active"{%/if%}><a href="{%baseUrl($params['account']->identifier)%}/{%$params['project']->identifier%}/tree/master"><i class="glyphicon glyphicon-hdd"></i> 版本库</a></li>
